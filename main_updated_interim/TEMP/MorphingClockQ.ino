...
Update 7/28/2025
Fixed display bug if temperature was over 99.  
...
// Set weather icon position; TF_cols = 4 by default  (TF_cols is the width of each character)
